...
export function Footer({ afterBand = false }: { afterBand?: boolean }) {
  return (
    <footer className={`footer ${afterBand ? "footer--after-band" : ""}`.trim()}>
      ...
      <img src="/brand/emma-williams-signature.svg" alt="Emma Williams Photography" className="footer__logo" />
      ...
      <Editable k="shared.footer.fine" as="span" className="footer__fine">Tulsa, Oklahoma &amp; surrounding areas · © 2026 Emma Williams Photography</Editable>
    </footer>
  );
}
